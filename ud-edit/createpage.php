...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<label class="description" for="element_7">Email-ID </label>
		<div>
			<input id="element_7" name="element_7" class="element text medium" type="text" maxlength="255" value=""/> 
				...
				<input id="saveForm" class="button_text" type="button" name="Update" value="Update"  onclick="editProfile()"/>
		</li>
			</ul>
		</form>	
		<div id="footer">
