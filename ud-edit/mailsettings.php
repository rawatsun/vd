...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<form id="form_597978" class="appnitro"  method="GET" action="">
			...
			<h2>Enter Your Mail Settings</h2>
		...
		<div>
			<input id="element_4" name="element_4" class="element text medium mailpwd" type="text" maxlength="255" /> 
		...
		<span class ="pass"></span>
				...
				<input id="saveForm" class="button_text" type="button" name="Save" value="<?php echo SAVE ; ?>"  onclick="mailSettings()"/>
		</li>
			</ul>
		</form>	
		<div id="footer">
