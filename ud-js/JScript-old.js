...
//-----------------------------------------------hiding all divisions of page on load-------------------
    ...
    $(".home1").css({"display":"block"}).hide().fadeIn("fast");
...
$(".deleteprofile").click(function (){
 ...
 $(".choosetemplate1").css({"display":"none"});
    ...
    $(".template").click(function (){ $(".donation1").css({"display":"none"});
...
//--------------------------- code for hiding all div except homeclick on click home-------------------
 $(".homeclick").click(function (){
  ...
  $(".choosetemplate1").css({"display":"none"}); $(".donation1").css({"display":"none"});
...
//--------------------------------end of code--------------------------------------------------------------------
 ...
 $(".editprofile").click(function (){
   ...
   $(".page1").css({"display":"none"}); $(".donation1").css({"display":"none"});
...
//--------------------------- code for hiding all div except createpage on click deleteprofile-------------------
 $(".createpage").click(function (){
