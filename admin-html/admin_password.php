...
<li id="li_2" >
		...
		<div>
		<input id="element_2" name="element_2" class="element text medium element_2" type="text" maxlength="255"/>		
	    </div> 
...
<li id="li_3" >
		...
		<div>
		<input id="element_3" name="element_3" class="element text medium element_3" type="text" maxlength="255"/> 
        </div> 
...
<li class="buttons">
				...
				<input id="saveForm" class="button_text" type="button" name="Change Password" value="<?php echo CHANGE_PASSWORD1; ?>"  onclick="adminChangePassword()"/>
	   	</li>
			</ul>
		</form>	
